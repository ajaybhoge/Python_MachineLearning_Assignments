...
##################################################
#
#  Step 8 : Predict Marks For 6 Study Hours
#
##################################################

print(Border)
print("Step 8 : Predict Marks For 6 Study Hours")
print(Border)

NewStudyHours = np.array([[6]])

Prediction = model.predict(NewStudyHours)

print("Predicted Marks For 6 Study Hours :",Prediction[0])

##################################################
#
#  Step 9 : Regression With Two Features
#
##################################################

print(Border)
print("Step 9 : Regression With Two Features")
print(Border)

StudyHours = np.array([1,2,3,4,5])
SleepHours = np.array([7,6,7,6,8])
Marks = np.array([50,55,60,65,70])

X = np.column_stack((StudyHours,SleepHours))
Y = Marks
...
print("Coefficient For StudyHours :",model2.coef_[0])
print("Coefficient For SleepHours :",model2.coef_[1])
print("Intercept :",model2.intercept_)

##################################################
#
#  Step 10 : Importance Of Coefficients
#
##################################################

print(Border)
print("Step 10 : Importance Of Coefficients")
print(Border)

print("Coefficients are important because they show")
print("the effect of input features on the prediction.")
print("A positive coefficient increases the prediction")
print("when the feature increases.")
print("A negative coefficient decreases the prediction.")
print("The size of a coefficient shows the direction and")
print("amount of change in the model when the feature changes,")
print("with the other features kept constant.")
