...
##################################################
#
#  Step 9 : Why R2 Cannot Be Greater Than 1
#
##################################################

print(Border)
print("Step 9 : Why R2 Cannot Be Greater Than 1")
print(Border)

print("R2 is based on the ratio of residual error")
print("to total variation.")
print("For the usual regression definition, the best")
print("possible value is 1.")

##################################################
#
#  Step 10 : KNN For Regression
#
##################################################

print(Border)
print("Step 10 : KNN For Regression")
print(Border)

print("Yes, KNN can be used for regression.")
print("For regression, KNN can use the target values")
print("of nearby points to calculate a predicted value.")
